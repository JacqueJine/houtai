  ...
  <div class="add">
    ...
    <el-form ref="form" :model="form" :rules="rules" style="width:80%;" label-width="120px">
      ...
      <div class="form">
        ...
        <el-form-item v-if="editgame.sell_mid!=0" label="联系方式" prop="tel" required>
          <el-input placeholder="请输入联系方式" style="width:200px" v-model="form.tel"></el-input>
        </el-form-item>
    ...
    <el-dialog title="账号审核拒绝" :visible.sync="deductionShow" width="25%" center>
      <el-form :model="deduction" ref="ruleForm2" size="small" :rules="rules2">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="deductionBox('ruleForm2')">保 存</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    // 拒绝
    refuse() {
      this.deduction.id = this.editgame.id;
