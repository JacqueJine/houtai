<template>
  <div class="mall">
    ...
    <div class="screen">
      <el-form label-width="70px" :inline="true" size="mini" class="demo-form-inline">
        <el-form-item style="float:right">
          <el-button type="primary" size="small" round @click="shelves('id')">批量上架</el-button>
          <el-button type="primary" size="small" round @click="delGoods('id')">批量删除</el-button>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="order" label="添加时间" sortable width="300">
          <template slot-scope="{row}">
            <p>{{row.add_time}}</p>
        ...
        <el-table-column label="操作" fixed="right" width="240">
          <template slot-scope="{row}">
            <div class="operation">
              <span class="colorGreen" @click="shelves(row.id)">上架</span>
              <span class="colorBlue" @click="edit(row)">编辑</span>
              <span class="colorRed" @click="delGoods(row.id)">删除</span>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    ...
    edit(row) {
      ...
      if (this.activeName == "chushou" || this.activeName == "number") {
        goods_ = "number";
        this.$router.push({ path: "/editAdd", query: { game: row } });
      } else if (this.activeName == "gift") {
        goods_ = "gift";
