      ...
      >
        <div style="display:flex;justify-content: space-between;">
          <el-form-item label="礼物分类" required prop="class_id">
            <el-select disabled="true" v-model="form.class_id" placeholder="请选择分类">
        ...
        <el-form-item label="出售价格" required prop="price">
          <el-input disabled="true" v-model="form.price" placeholder="请输入出售价格"></el-input>
        </el-form-item>
        <el-form-item label="出售数量" required prop="gift_number">
          <el-input disabled="true" v-model="form.gift_number" placeholder="请输入出售数量"></el-input>
        </el-form-item>
        <el-form-item v-if="gift.sell_mid!=0" label="联系方式" required prop="gift_number">
          <el-input disabled="true" v-model="form.tel" placeholder="请输入联系方式"></el-input>
        </el-form-item>
        <!-- <el-form-item>
